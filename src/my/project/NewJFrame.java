...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(247, 150, 29));
        ...
        ProgressBar.setBackground(new java.awt.Color(255, 153, 51));
        ProgressBar.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/school-logo-template-png-1.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Central Technical School");
        ...
        jLabel1.setText("©Jubayer Corporation");
    ...
    public static void main(String args[]) throws InterruptedException {
       ...
       int i;
        for(i=0; i<=100; i++){
        Thread.sleep(70);
        jframe.load.setText(i+"%");
        jframe.ProgressBar.setValue(i);
            if(i==100){
            jframe.dispose();
            School s=new School();
            s.setVisible(true);
